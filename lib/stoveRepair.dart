...
class Stove_Repair extends StatefulWidget {
  const Stove_Repair({Key? key}) : super(key: key);

  @override
  _Stove_RepairState createState() => _Stove_RepairState();
}

class _Stove_RepairState extends State<Stove_Repair> {
  var size, height, width;
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('employeesDetails')
      .where('category', isEqualTo: 'Stove Repair')
